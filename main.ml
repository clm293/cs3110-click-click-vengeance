...
type key = Left | Down | Up | Right | Space
...
let init_graphics s = 
  ...
  draw_image (make_image (create_left_arrow_matrix Graphics.black Graphics.magenta)) 40 385;
  draw_image (make_image (create_down_arrow_matrix Graphics.black Graphics.yellow)) 155 385;
  draw_image (make_image (create_up_arrow_matrix Graphics.black Graphics.green)) 270 385;
  draw_image (make_image (create_right_arrow_matrix Graphics.black Graphics.cyan)) 395 385;
